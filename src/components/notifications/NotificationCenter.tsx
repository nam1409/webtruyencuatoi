...
export function NotificationCenter() {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case "reply": return <MessageSquare className="w-4 h-4 text-emerald-500" />;
      case "update": return <Bell className="w-4 h-4 text-amber-500" />;
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="relative rounded-2xl bg-background/50 hover:bg-background border border-border/50 w-12 h-12 shadow-sm">
      ...
      <DropdownMenuContent align="end" className="w-[350px] md:w-[400px] rounded-[2rem] md:rounded-[2.5rem] p-4 bg-background/95 backdrop-blur-2xl border-border/40 shadow-2xl mt-2 z-[100]">
